...
import java.util.Scanner;
    ...
    public class onlineExamForm  {
        public static void main(String[] args) {
            ...
            id=sc.nextInt();
            int count=0;
            System.out.println("\t\tWelcome " +name+ " to Oasis Online Examination form");

            do
            {


                System.out.println(" 1.Take Exam first");
                ...
                if(ch==4)
                {
                    System.out.println("Thank you so much for taking exam");
                    break;
                }
                switch(ch)
                {
                    case 1:
                    {
                        System.out.println("Select one programming language:");
                        ...
                        System.out.println("Each question consist of 4 option you have to choose correct answer for that question6");
                        if(sub==2)
                        {
                            count=0;
